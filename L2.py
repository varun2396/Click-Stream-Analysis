...
def lambda_handler(event, context):
    ...
    for record in event['records']:
        ...
        document = {'session_id': msn['SESSION_ID'], 'user_id': msn['USER_ID'], 'device': msn['DEVICE'],'timeagg': msn['TIMEAGG'],
        ...
        fh.put_record(DeliveryStreamName='sessionisedStream',Record={ 'Data': documentjson})
        cw_write = {
